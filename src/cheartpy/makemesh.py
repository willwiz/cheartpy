...
cube = subpar.add_parser("cube", help="3D cube mesh linear",
                         add_help=False, parents=[cube_parser])
...
arc = subpar.add_parser("arc", help="3D arc mesh",
                        add_help=False, parents=[arc_parser])
arc.set_defaults(run=arc_main)
cylinder.set_defaults(run=cylinder_main)
time = subpar.add_parser("time", help="nonlinear time steps",
                         add_help=False, parents=[time_parser])
