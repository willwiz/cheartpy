...
cylinder = subpar.add_parser("cylinder", help="3D cylinder mesh", add_help=False, parents=[cylinder_parser])
...
cylinder.set_defaults(run=cylinder_main)
time = subpar.add_parser("time", help="nonlinear time steps", add_help=False, parents=[time_parser])
