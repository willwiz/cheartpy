...
from .mesh.make_block import parser as cube_parser
from .mesh.make_cylinder import main as cylinder_main
from .mesh.make_cylinder import parser as cylinder_parser
from .mesh.make_square import main as square_main
from .mesh.make_square import parser as square_parser
