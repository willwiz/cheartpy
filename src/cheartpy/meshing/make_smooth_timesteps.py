...
def find_parameter(dt0, n0, n1, n2, Tf):
    ...
    optres = minimize(
        obf, np.array([1.0]), bounds=Bounds([0.5], [1.001]), method="TNC", tol=1e-14
    )
    return optres.x
...
print(
    "    The second part has {} steps with multiplier of {} and {} time elapsed".format(
        list_dt1.size, par, list_dt1.sum()
    )
)
print(
