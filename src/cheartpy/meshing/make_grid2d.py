...
parser.add_argument(
    "xlen", metavar="X Length", type=float, help="Length in the X direction"
)
parser.add_argument(
    "xn", metavar="X Elem", type=int, help="Number of elements in the X direction"
)
parser.add_argument(
    "xoff",
    metavar="X Offset",
...
parser.add_argument(
    "ylen", metavar="Y Length", type=float, help="Length in the Y direction"
)
parser.add_argument(
    "yn", metavar="Y Elem", type=int, help="Number of elements in the Y direction"
)
parser.add_argument(
    "yoff",
    metavar="Y Offset",
