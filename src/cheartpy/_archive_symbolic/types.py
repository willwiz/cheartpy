...
class _Symbol:
    ...
    @abc.abstractmethod
    def __add__(self, other: Number | _Symbol | _Expression) -> _Expression: ...

    @abc.abstractmethod
    def __sub__(self, other: Number | _Symbol | _Expression) -> _Expression: ...

    @abc.abstractmethod
    def __mul__(self, other: Number | _Symbol | _Expression) -> _Expression: ...

    @abc.abstractmethod
    def __div__(self, other: Number | _Symbol | _Expression) -> _Expression: ...

    @abc.abstractmethod
    def __pow__(self, other: Number | _Symbol | _Expression) -> _Expression: ...

    @abc.abstractmethod
    def __mod__(self, other: Number | _Symbol | _Expression) -> _Expression: ...
...
class _Expression:
    ...
    def __init__(
        ...
        self.op = op
        self.term2 = Number(term2) if isinstance(term2, (int, float)) else term2
    ...
    @abc.abstractmethod
    def __sym_div__(self, other: _Symbol) -> Number | _Symbol | _Expression: ...
