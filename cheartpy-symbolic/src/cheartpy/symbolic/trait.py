...
type ALL_TYPES = ExpressionTrait | ScaledTrait | SymbolTrait | FunctionTrait | int | float
type NEGATABLE_TYPES = ExpressionTrait | SymbolTrait | FunctionTrait
type SCALABLE_TYPES = SymbolTrait | ScaledTrait | FunctionTrait
...
class ScaledTrait(abc.ABC):
    @abc.abstractmethod
    def __init__(self, scalar: float, value: IMMUTABLE_TYPES) -> None: ...
    @abc.abstractmethod
    def __str__(self) -> str: ...
    @abc.abstractmethod
    def __hash__(self) -> int: ...
    ...
    def __eq__(self, other: object) -> bool: ...
    @abc.abstractmethod
    def __neg__(self) -> ScaledTrait | IMMUTABLE_TYPES: ...
    @abc.abstractmethod
    def __add__(self, other: ALL_TYPES) -> ALL_TYPES: ...
    @abc.abstractmethod
    def __radd__(self, other: ALL_TYPES) -> ALL_TYPES: ...
    ...
    @property
    @abc.abstractmethod
    def value(self) -> IMMUTABLE_TYPES: ...
    @property
    @abc.abstractmethod
