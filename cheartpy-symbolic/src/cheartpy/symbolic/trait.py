...
type ALL_TYPES = (
    NegativeTrait | ExpressionTrait | ScaledSymbolTrait | SymbolTrait | FunctionTrait | int | float
)
type NEGATABLE_TYPES = (
    NegativeTrait | ExpressionTrait | ScaledSymbolTrait | SymbolTrait | FunctionTrait
)
type SCALABLE_TYPES = ScaledSymbolTrait | SymbolTrait | FunctionTrait
type IMMUTABLE_TYPES = ScaledSymbolTrait | SymbolTrait | FunctionTrait
...
class NegativeTrait(abc.ABC):
    @abc.abstractmethod
    def __init__(self, value: NEGATABLE_TYPES) -> None: ...
    @abc.abstractmethod
    ...
    @property
    @abc.abstractmethod
    def value(self) -> NEGATABLE_TYPES: ...
...
class ExpressionTrait(abc.ABC):
    ...
    def __eq__(self, other: object) -> bool: ...
    @abc.abstractmethod
    def __neg__(self) -> NegativeTrait | ExpressionTrait: ...
    @abc.abstractmethod
    def __add__(self, other: ALL_TYPES) -> ExpressionTrait: ...
    @abc.abstractmethod
    def __radd__(self, other: ALL_TYPES) -> ExpressionTrait: ...
