...
class MaxwellBranch(ILaw):
    tau: float
    store: IVariable
    name: Literal["maxwell-branch", "maxwell-truesdell", "maxwell-dev"] = "maxwell-branch"
...
class FractionalVE(ILaw):
    ...
    name: Literal["fractional-ve", "fractional-truesdell", "fractional-dev"] = "fractional-ve"
    InitPK2: int | bool = True
    ZeroPK2: bool = False
    Order: Literal[1, 2] = 2
    laws: list[Matlaw] = dc.field(default_factory=list[Matlaw])
...
@dc.dataclass
class FractionalTruesdell(ILaw):
    alpha: float
    np: int
    Tf: float
    store: IVariable
    Tscale: float | None = 10.0
    name: Literal["fractional-truesdell"] = "fractional-truesdell"
    InitPK2: int | bool = True
    ZeroPK2: bool = False
    Order: Literal[1, 2] = 2
    laws: list[Matlaw] = dc.field(default_factory=list[Matlaw])
